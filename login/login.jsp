...
<%
    ...
    ResultSet rs = null;
        String url = "jdbc:postgresql://ezojehqoqbpqmlvxlapb.supabase.co:5432/postgres"; // URL de Supabase
    String dbUsername = "postgres.ezojehqoqbpqmlvxlapb";
    String dbPassword = "_$Du-8gryXvGgW@";
